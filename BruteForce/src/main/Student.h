 ...
 *
 * int StID	- Common integer to keep track of student in data structures.
 *
 * int ClassID - Unique integer depicting the Class/Section the student is assigned to.
 *
 * int ProjectID - Unique integer depicting the project that the student is assigned to.
 *
 * int Skills[] - Students are given a survey in which they indicate their familiarity or
 ...
 *
 * int Availability[] -	Students indicate their preferred meeting times on the student survey.
